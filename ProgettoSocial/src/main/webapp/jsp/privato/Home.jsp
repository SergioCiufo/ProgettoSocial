...
<head>
  ...
  <title>ProgettoFinale_Home</title>
...
<% 
		...
		//request.getSession().setAttribute("PaginaAttuale","Home");
		request.getSession().setAttribute(Costanti.CHIAVE_PAGINA_ATTUALE, Costanti.VALORE_PAGINA_ATTUALE_HOME);
	%>
<body id="mode">
  <div class="container-fluid d-flex flex-column min-vh-100">
    ...
    <div class="row flex-grow-1">
      ...
      <div class="col-8 mb-3">
        ...
        <%
        List<Post> elencoPost=(List<Post>)request.getAttribute(Costanti.CHIAVE_ELENCO_POST);
        String filtroPost=(String)request.getSession().getAttribute(Costanti.HTML_FORM_SELECT_ORDINAPOST);
        %>
        <% 
          if ( elencoPost != null && elencoPost.size() > 0 ) {	
        	  System.out.println(" elenco normale" + elencoPost);
        	// if(filtroPost!=null && filtroPost.equals("piuRecente")){
   			//	Collections.reverse(elencoPost);
   			//	System.out.println("elenco al contrario"+	elencoPost);
   			//} //else if (filtroPost!=null && filtroPost.equals("piuLike")){
            ...
            <div class="row ">
              ...
              <div class="col-8 mt-3 postColor"  style="border: solid 1px black; border-radius: 1%;">
                ...
                <% List<Commenti> elencoCommenti=(List<Commenti>)request.getAttribute(Costanti.CHIAVE_ELENCO_COMMENTI);
                  String erroreCommento=(String)request.getAttribute(Costanti.CHIAVE_ERRORE_COMMENTO);
                %>
                <%
        ...
        <div class="row mb-3">
          ...
          <div class="col-6 d-flex justify-content-center">
            <form action="<%=request.getContextPath() + "/Home"%>" method="post">
              <select class="form-select" name="<%=Costanti.HTML_FORM_SELECT_ORDINAPOST%>">
                <option value="piuRecente">Piu' Recente</option>
                <option value="menoRecente">Meno Recente</option>
                <option value="piuLike">Più Popolari</option>
              </select>
          </div>
          <div class="col-3 d-flex justify-content-start align-items-center">
            <button type="submit" style="background: transparent; border: none;"><img style="width:65%;" src="<%= "http://" + request.getServerName() + ":" + request.getServerPort() + request.getContextPath() + "/img/find.png"%>"></button>
              </form>
          </div>
        </div>
        <!--END FIND-->
