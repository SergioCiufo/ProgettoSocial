...
<head>
  ...
  <% Utente utenteRicercato=(Utente)request.getSession().getAttribute("utenteRicercato"); %>
<title> <%=utenteRicercato.getNome()+" "+ utenteRicercato.getCognome() %></title>
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css" />
	...
	<% 
		...
		//request.getSession().setAttribute("PaginaAttuale","ProfiloGenerico");
		request.getSession().setAttribute(Costanti.CHIAVE_PAGINA_ATTUALE,Costanti.VALORE_PAGINA_ATTUALE_PROFILOGENERICO);
	%>
<body id="mode">
    ...
    <div class="row flex-grow-1">
     ...
     <div class="row mt-3">
          <div class="col-4 d-flex align-items-center justify-content-end">
            <img class="fotoProfilo" src="<%=mappaImmagineUtenti.get(utenteRicercato.getId())%>">
          </div>
          <div class="col-4 d-flex align-items-center justify-content-center">
            <h1> <%=utenteRicercato.getNome()+" "+utenteRicercato.getCognome()%></h1>
          </div>
          <div class="col-3 d-flex align-items-center">
            <h3>@<%=utenteRicercato.getUsername() %> </h3>
          </div>
        </div>
        
        <div class="row"> 
       <% 
			if ( utenteRicercato.getPostPersonali() != null && utenteRicercato.getPostPersonali().size() > 0 )
		{

			for(Post p:utenteRicercato.getPostPersonali()){
		%>
          <div class="col-12">
